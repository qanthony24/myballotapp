...
const InfoEssentialsPage: React.FC = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="bg-white shadow-xl rounded-lg p-6 md:p-10 border border-midnight-navy/10">
        <Link to="/info" className="text-civic-blue hover:underline text-sm mb-4 inline-flex items-center">
          <ArrowLeftIcon className="h-4 w-4 mr-1" /> Back to Info
        </Link>

        <h1 className="text-3xl font-display font-bold text-midnight-navy mb-8 text-center">Election Essentials</h1>
